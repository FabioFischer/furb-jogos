...
{
    public class PlayerLudwig : MonoBehaviour, IPlayer
    {
        private float xMin;
        private float xMax;
        private float yMin;
        ...
        void Start()
        {
            ...
            GameManager.GetMovementBoundaries
                (
                    GameObject.Find("Scene").GetComponentInChildren<SpriteRenderer>(), // Após a estruturação dos levels, utilizar o background
                    out this.xMin,
                    out this.xMax,
                    out this.yMin,
                    out this.yMax,
